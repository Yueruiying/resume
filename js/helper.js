...
var HTMLwelcomeMsg = '<h3 class="welcome-message" id="changeText">%data%</h3>';
...
var HTMLworkEmployer = '<a class="ext_links" href="#" target="_blank">%data%';
...
var HTMLprojectTitle = '<a class = "ext_links" href="#" target="_blank">%data%</a>';
var HTMLprojectDates = '<div class="date-text">%data%</div>';
var HTMLprojectDescription = '<p><br>%data%</p>';
var HTMLprojectImage = '<img src="%data%" height=50px width=100px>';

var HTMLschoolStart = '<div class="education-entry"></div>';
var HTMLschoolName = '<a class="ext_links" href="#" target="_blank"></i>%data%';
...
var HTMLonlineTitle = '<a class="ext_links" href="#" target="_blank">%data%';
...
var contentString = '<div id="content">' + '<div id="siteNotice">' + '</div>' + '<h4>Yes, I have been here.<h4>';
